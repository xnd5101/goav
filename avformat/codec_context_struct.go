...
//////////////////////
// fix by xnd on 2021-12-30
/////////////////////
func (cctxt *CodecContext) GetCodec() *AvCodec {
	return (*AvCodec)(unsafe.Pointer(cctxt.codec))
}

func (cctxt *CodecContext) SetCodecTag(v uint) {
	cctxt.codec_tag = C.uint(v)
}
